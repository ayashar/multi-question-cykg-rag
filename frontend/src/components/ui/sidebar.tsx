...
export default function Sidebar() {
  ...
  return (
    <aside className="w-16 min-w-16 lg:w-64 lg:min-w-64 h-screen sticky top-0 flex flex-col justify-between border-r border-neutral-300 bg-background select-none z-20">
      <div className="flex flex-col">
        ...
        <nav aria-label="Main navigation" className="mt-4 px-1 lg:px-3 flex flex-col space-y-1">
      ...
      <div className="px-1 lg:px-3 pb-6 flex flex-col space-y-1">
        <Link
        ...
        >
        <Settings className="w-5 h-5 shrink-0 text-neutral-800 group-hover:text-neutral-1000" />
